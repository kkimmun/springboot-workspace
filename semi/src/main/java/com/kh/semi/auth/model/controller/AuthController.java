package com.kh.semi.auth.model.controller;
...
public class AuthController {
	...
	// 성공시에 서버는 JWT를 만들어서 클라이언트에게 응답을 보냄
	// 실패시에 서버는 예외를 발생시켜서 JSON예외 객체를 응답해준다
	...
	public ResponseEntity<?> login(@RequestBody LoginRequestDto member){
		LoginResponse res = authService.login(member);
