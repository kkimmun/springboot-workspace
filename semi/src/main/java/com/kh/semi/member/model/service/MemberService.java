...
public class MemberService {
	 ...
	 * 
	 * 확장성 => 미래에 메소드에 한 줄 추가됐을 때 원자성이 자동으로 보장됨
	 * 
	 * 컨벤션, 유지보수
	 * 
	 * 커넥션, sqlSession 재활용
	...
	private void validatedPassword(String rqwPassword, String encodedPassword) {
		if(!passwordEncoder.matches(rqwPassword, encodedPassword)) {
			throw new CustomAuthenticationException("비밀번호가 일치하지 않습니다.");
		}
	}
